...
class TypingQuizController extends GetxController {
  ...
  Future<void> checkAnswer(String japanese) async {
    final cleanJapanese = japanese.replaceAll("～", "").replaceAll(" ", "");
    final isCorrect = answerController.text.trim() == cleanJapanese;
    ...
    if (isCorrect) {
      ...
      _showIncorrectBottomSheet(cleanJapanese);
    }
  }
